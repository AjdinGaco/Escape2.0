...
public class WordPuzzleSearch : RoomPuzzle
{
    ...
    void Start()
    {
        ...
        foreach (string word in allWords)
        {
            ...
            } while (spawnedWordPositions.Any(pos => Vector2.Distance(randomPos, pos) < textPrefab.GetComponent<TextMeshProUGUI>().preferredWidth * 1.5f));
            ...
            if (importantWords.Contains(word))
            {
                ...
                newTextObject.GetComponent<ButtonScript>().interactionSound = audioClip;
